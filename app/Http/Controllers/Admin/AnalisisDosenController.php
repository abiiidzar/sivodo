...
use App\Exports\AnalisisDosenExport;

class AnalisisDosenController extends Controller
{
    /**
     * Halaman utama analisis dosen
     */
    public function index(Request $request)
    {
        ...
        return view('admin.analisis.index', compact('dosens', 'prodiList'));
    }

    /**
     * Detail analisis per dosen
     */
    ...
    public function exportPdf($id)
    {
        ...
        $pdf = Pdf::loadView('admin.analisis.export-pdf', $data);
    ...
    private function getKategori($rata)
    {
        ...
        if ($rata >= 2.00) return ['label' => 'Baik', 'class' => 'bg-blue-500'];
