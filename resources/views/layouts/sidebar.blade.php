...
<aside class="w-64 bg-white border-r border-gray-200 hidden md:block min-h-[calc(100vh-4rem)]">
    <div class="p-4 space-y-2">
        ...
        @if($user->isAdmin())
            ...
            <a href="{{ route('admin.grafik') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('admin.grafik') ? 'bg-navy text-white' : 'text-gray-600 hover:bg-gray-100' }}">
