...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.mahasiswa.update', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="program_studi" name="program_studi" value="{{ old('program_studi', $mahasiswa->program_studi) }}"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="username" name="username" value="{{ old('username', $mahasiswa->user->username) }}"
            ...
            <div>
                ...
                <input type="text" id="no_hp" name="no_hp" value="{{ old('no_hp', $mahasiswa->user->no_hp) }}"
            ...
            <!-- Status Voting (Readonly) -->
            <div>
                <label class="block text-sm font-medium text-navy mb-1">Status Voting</label>
                <input type="text" value="{{ $mahasiswa->status_voting }}" readonly
                       class="w-full rounded-lg border-gray-200 bg-gray-50 {{ $mahasiswa->status_voting == 'Sudah' ? 'text-emerald-600' : 'text-red-500' }}">
            </div>
