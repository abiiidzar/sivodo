        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                ...
                <div class="flex items-center w-full sm:w-56 h-11 border border-gray-300 rounded-lg overflow-hidden">
                    ...
                    <div class="flex-1">
                        <input type="text" id="searchHasil" placeholder="Cari Nama Dosen..."
            ...
            <span class="text-sm text-gray-500">Total: {{ $dosens->count() }} dosen</span>
        </div>
    </div>
...
<script>
    document.getElementById('btnSearch').addEventListener('click', function() {
        const search = document.getElementById('searchHasil').value;
        const prodi = document.getElementById('filterProdi').value;
        let url = '{{ route("mahasiswa.hasil") }}?';
    ...
    document.getElementById('searchHasil').addEventListener('keypress', function(e) {
        if (e.key === 'Enter') {
