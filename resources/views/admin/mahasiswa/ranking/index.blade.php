        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <div class="flex items-center w-full sm:w-56 h-11 border border-gray-300 rounded-lg overflow-hidden">
                    ...
                    <div class="flex-1">
                        <input type="text" id="searchRanking" placeholder="Cari Nama/NIDN..."
...
<script>
    document.getElementById('btnSearch').addEventListener('click', function() {
        const search = document.getElementById('searchRanking').value;
        const prodi = document.getElementById('filterProdi').value;
        let url = '{{ route("mahasiswa.ranking") }}?';
    ...
    document.getElementById('btnReset').addEventListener('click', function() {
        window.location.href = '{{ route("mahasiswa.ranking") }}';
    });

    document.getElementById('searchRanking').addEventListener('keypress', function(e) {
        if (e.key === 'Enter') {
